 ...
 */
   ...
   *
   */  
  graphTypeToString (aType) {
    if (aType==GRAPHTYPES.NODE) {
      return ("node");
    }

    if (aType==GRAPHTYPES.GROUP) {
      return ("node");
    }
    
    if (aType==GRAPHTYPES.EDGE) {
      return ("node");
    }
    
    if (aType==GRAPHTYPES.GRAPH) {
      return ("node");
    }
    
    if (aType==GRAPHTYPES.NOTE) {
      return ("node");
    }                
  }
